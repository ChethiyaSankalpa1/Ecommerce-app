  ...
  return (
    <div className="w-[18%] min-h-screen border-r-2 bg-white shadow-md">
      <div className="flex flex-col gap-4 pt-6 pl-[20%] text-[15px]">
        ...
        <NavLink
          to="/add"
          className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded hover:bg-gray-100"
        >
        ...
        <NavLink
          ...
          className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded hover:bg-gray-100"
        >
          <img className="w-5 h-5" src={assets.order_icon} alt="Earnings Icon" />
