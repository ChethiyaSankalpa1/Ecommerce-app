...
const Hero = () => {
  return (
    <div className='flex flex-col sm:flex-row bg-gray-100'> {/* Lighter gray */}
      ...
      {/* Hero Right Section Image */}
       <img className='w-full sm:w-1/2 h-auto object-cover mt-4 sm:mt-0' src={assets.hero_img} alt='Hero Image' />
    </div>
  );
};
